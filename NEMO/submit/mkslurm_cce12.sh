#!/bin/ksh
#
# ./bm/det/mkslurm_cce12.sh -S 128 -s 16 -m 2 -C 3072 -c 2 > ./bm/det/cce12_cmpich8_ofi_n64.ll
# ./bm/det/mkslurm_cce12.sh -S 64 -s 16 -m 2 -C 1536 -c 2 > ./bm/det/cce12_cmpich8_ofi_n32.ll
# ./bm/det/mkslurm_cce12.sh -S 32 -s 16 -m 2 -C 768 -c 2 > ./bm/det/cce12_cmpich8_ofi_n16.ll
# ./bm/det/mkslurm_cce12.sh -S 16 -s 16 -m 2 -C 384 -c 2 > ./bm/det/cce12_cmpich8_ofi_n8.ll
...
nc_sparsity=$NC_SP
#
EXEC1=/work/z19/shared/utils/xios/2.5/cce/12/cmpich/8/bin/xios_server.exe
EXEC2=/work/z19/z19/mrb23cab/tests/nemo/4.0.6/cce12/cmpich8/cfgs/GYRE_PISCES_CFG/BLD/bin/nemo.exe
...
# Created by: mkslurm_cce12.sh -S $NSE -s $NS_SP -m $NS_PN -C  $NCL -c  $NC_SP -t $TIM -a $ACCT -j $NAM
